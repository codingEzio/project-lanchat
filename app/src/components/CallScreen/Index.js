    ...
    return (
      ...
      >
        ...
        <div>
          ...
          >
            <DialogTitle
              className="list-title copy-dialog"
            ...
            >
              ...
              <span className="float-right" onClick={this.showSearchBar}>
                <img
                  ...
                  style={{
                    filter:
                      'invert(100%) sepia(70%) saturate(2358%) hue-rotate(346deg) contrast(10%)',
                  }}
                  alt="close"
                />
              </span>
                      ...
                      <div class="overlay">
                        ...
                        {!this.state.isInput ? (
                          <img
                            src={Pencil}
                            alt="Pencil"
                            className="img-fluid px-2 pencil-icon-call"
                          />
                        ) : (
                          ''
                        )}
